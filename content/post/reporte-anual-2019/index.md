...
En el correr de un año se convocaron 3 reuniones virtuales, en torno a 
    ...
    + **Datos, Metadatos y Data Papers** (determinación de campos a ser sistematizados para los datos y metadatos, e introducción de la modalidad de data papers), y 
    + **Registros de Ciencia Ciudadana** (colaboración con la plataforma global iNaturalist e integración de Uruguay a la red).
